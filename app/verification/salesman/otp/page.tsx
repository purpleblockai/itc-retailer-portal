...
export default function SalesmanOTPVerificationPage() {
  ...
  useEffect(() => {
    ...
    const storedPhone = sessionStorage.getItem("salesmanPhone")
    if (storedPhone) {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-black overflow-hidden p-6">
      ...
      {/* Back button */}
      <a href="/verification/salesman" className="text-white p-2 rounded-full hover:bg-gray-800 transition-colors z-10">
